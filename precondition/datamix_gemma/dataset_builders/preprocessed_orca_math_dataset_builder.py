...
"""Dataset builder for the Preprocessed Orca Math dataset."""
...
class PreprocessedOrcaMathDatasetBuilder(dataset_builder.DatasetBuilder):
  ...
  def __init__(
    ...
    self._base_data = tf.data.TFRecordDataset(
        [orca_math_path], num_parallel_reads=tf.data.AUTOTUNE
    )
